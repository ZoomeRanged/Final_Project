...
with DAG(
    ...
    create_fact_total_per_state = PostgresOperator(
        ...
        sql = open("/home/agnes/Documents/digital_skola/Project/final_project/fact_table/fact_total_per_state.sql").read()
    )
    ...
    create_fact_daily_avg_currency = PostgresOperator(
        ...
        postgres_conn_id = "airflow_final_project",
        sql = open("/home/agnes/Documents/digital_skola/Project/final_project/fact_table/fact_daily_avg_currency.sql").read()
    )
